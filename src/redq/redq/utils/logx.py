...
class Logger:
    ...
    def __init__(self, output_dir=None, output_fname='progress.txt', exp_name=None, use_wandb=False):
        """
        Initialize a Logger.
        ...
        if self.use_wandb:
            if not wandb.run:
                print(colorize("Warning: wandb.init() has not been called yet. Please initialize wandb before using Logger.", 'yellow', bold=True))
    ...
    def dump_tabular(self):
        ...
        if self.use_wandb and wandb.run and wandb_dict:
...
class EpochLogger(Logger):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, use_wandb=self.use_wandb, **kwargs)
        self.epoch_dict = dict()
