...
# for beta in 3.0; do
#     for sample_freq in 1; do
#         for top_reward_exclude_ratio in 0.1; do
#             for amplify in 1.0 2.0 3.0; do
#                 for finetune_lr in 1e-4 1e-5; do
...
#                     # 프로세스 실행
#                     CUDA_VISIBLE_DEVICES=$CURRENT_GPU python synther/online/online_cond2.py \
#                         --env reacher-hard-v0 \
#                         --gin_config_files config/online/sac_cond_synther_dmc.gin \
#                         --seed 0 --algorithm Ours --wandb \
#                         --finetune_lr $finetune_lr --beta $beta --backprop_iters 200 \
#                         --amplify $amplify --target_rnd_every 0 \
