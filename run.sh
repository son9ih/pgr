...
CUDA_VISIBLE_DEVICES=2 python synther/online/online_cond.py --env reacher-hard-v0 --gin_config_files config/online/sac_cond_synther_dmc.gin --gin_params 'redq_sac.cond_top_frac = 0.25' --wandb --seed 5 --state_ent --knn_k 12 --ent_eval_num 10000 --rnd --finetune --synther --reward_coef 1e5 --kl_weight 0.01 --histo &
sleep 5
...
sleep 5
CUDA_VISIBLE_DEVICES=4 python synther/online/online_cond.py --env reacher-hard-v0 --gin_config_files config/online/sac_cond_synther_dmc.gin --gin_params 'redq_sac.cond_top_frac = 0.25' --wandb --seed 6 --state_ent --knn_k 12 --ent_eval_num 10000 --rnd --finetune --synther --reward_coef 1e5 --kl_weight 0.01 --histo &
sleep 5
...
sleep 5
CUDA_VISIBLE_DEVICES=6 python synther/online/online_cond.py --env reacher-hard-v0 --gin_config_files config/online/sac_cond_synther_dmc.gin --gin_params 'redq_sac.cond_top_frac = 0.25' --wandb --seed 7 --state_ent --knn_k 12 --ent_eval_num 10000 --rnd --finetune --synther --reward_coef 1e5 --kl_weight 0.01 --histo &
sleep 5
